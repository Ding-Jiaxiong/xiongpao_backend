package com.dingjiaxiong.xiongpao_backend.job;
...
public class PreCacheJob {
    ...
    public void doCacheRecommendUser() {
        RLock lock = redissonClient.getLock("xiongpao:precachejob:docache:lock");
        try {
            // 只有一个线程能获取到锁
            if (lock.tryLock(0, -1, TimeUnit.MILLISECONDS)) {
                ...
                for (Long userId : mainUserList) {
                    ...
                    String redisKey = String.format("xiongpao:user:recommend:%s", userId);
