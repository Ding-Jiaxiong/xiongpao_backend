...
import com.dingjiaxiong.xiongpao_backend.common.DeleteRequest;
...
import com.dingjiaxiong.xiongpao_backend.model.request.TeamAddRequest;
...
public class TeamController {
    ...
    public BaseResponse<List<TeamUserVO>> listMyJoinTeams(TeamQuery teamQuery, HttpServletRequest request) {
        ...
        List<TeamUserVO> teamList = teamService.listTeamsWithIds(teamQuery, true);
        return ResultUtils.success(teamList);
    }
